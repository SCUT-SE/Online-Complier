    ...
    <div class="Login" v-if="isShow">
      ...
      <div class="login-left">
        <div class="content">
          ...
          <div>
            <el-button @click="loginRoom">建立聊天</el-button>
            <el-popover
              placement="top"
              width="200">
              <p>请输入房间id</p>
                    <el-input type="password" v-model="user.roomId" prefix-icon="el-icon-lock"></el-input>
              <div style="text-align: right; margin: 0">
                <el-button size="mini" type="text" @click="joinRoom">确定</el-button>
              </div>
              <el-button slot="reference" >加入房间</el-button>
            </el-popover>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    sendServer(content) {
      const { username, avatar, roomId } = this.user
      this.socket.emit('sendMessage', { msg: content, username, avatar,roomId })
    },
  },
  mounted() {
    /**
    ...
    this.socket.on("info disconnect",data=>{
